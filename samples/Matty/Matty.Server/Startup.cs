        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOpenIddict()
                ...
                .AddServer(options =>
                {
                    ...
                    // Note: All device codes could be exchanged once with the tokens.
                    // Using short-lived device codes is strongly recommended.
                    // The default Lifetime is null which can be specified to issue codes
                    // that never expire before exchanged with the tokens
